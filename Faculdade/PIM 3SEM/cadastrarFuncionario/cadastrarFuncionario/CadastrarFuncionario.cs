...
namespace cadastrarFuncionario
{
    ...
    {
        string connectionString = "Host=localhost;Port=5432;Database=IBH;Username=postgres;Password=gigliotti;";
        ...
        private void btn_salvar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strlog = "insert into login (login, senha, id_cargo, id_funcionario) values(@login, '123', @id_cargo, @id_funcionario)";

                NpgsqlCommand comando2 = new NpgsqlCommand(strlog, connection);

                comando2.Parameters.AddWithValue("@login", txt_cpf.Text);
                comando2.Parameters.AddWithValue("@id_cargo", int.Parse(cmb_cargo.SelectedValue.ToString()));
